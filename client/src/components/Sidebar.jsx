...
const Sidebar = () => {
  ...
  return (
    <>
      <div
          className=" text-white bg-black rounded-full z-50 absolute p-3 top-5 left-3"
          onClick={()=>setSlide(!slide)}
        >
          {!slide && <VscListSelection size={25} />}
        </div>

        {
          slide && <div> <div className="fixed top-0 left-0 z-20 bg-black h-full flex flex-col text-3xl px-9 py-8 gap-9 text-white ">
          <div
